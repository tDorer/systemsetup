...
# localcolabfold
conda create -p /home/tobias/models/localcolabfold/colabfold-conda -c conda-forge -c bioconda git python=3.10 openmm==8.2.0 pdbfixer kalign2=2.04 hhsuite=3.3.0 mmseqs2 -y
